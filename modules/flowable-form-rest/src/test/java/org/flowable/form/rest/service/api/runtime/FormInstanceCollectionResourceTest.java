...
import org.flowable.form.rest.service.api.BaseSpringFormRestTestCase;
import org.flowable.form.rest.service.api.form.FormRequest;
import org.junit.jupiter.api.Test;

import tools.jackson.databind.JsonNode;

public class FormInstanceCollectionResourceTest extends BaseSpringFormRestTestCase {
    ...
    public void testGetFormInstances() throws IOException {
        ...
        assertResultsSubmittedBy(url, USER);
    ...
    public void testGetFormInstanceById() throws IOException {
        ...
        String formInstanceId = dataNode.get(0).get("id").asString();
        ...
        assertThat(dataNode.get(0).get("id").asString()).isEqualTo(formInstanceId);
