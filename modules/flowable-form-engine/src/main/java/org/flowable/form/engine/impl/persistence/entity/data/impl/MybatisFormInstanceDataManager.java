...
public class MybatisFormInstanceDataManager extends AbstractFormDataManager<FormInstanceEntity> implements FormInstanceDataManager {
    ...
    @Override
    public void deleteFormInstancesByProcessInstanceId(String processInstanceId) {
        getDbSqlSession().delete("deleteFormInstancesByProcessInstanceId", processInstanceId, getManagedEntityClass());
    }

    @Override
    public void deleteFormInstancesByScopeIdAndScopeType(String scopeId, String scopeType) {
        Map<String, Object> params = new HashMap<>();
        params.put("scopeId", scopeId);
        params.put("scopeType", scopeType);
        getDbSqlSession().delete("deleteFormInstancesByScopeIdAndScopeType", params, getManagedEntityClass());
    }
