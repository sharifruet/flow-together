...
public class FormEngineConfiguration extends AbstractEngineConfiguration
    ...
    protected FormFieldValidator formFieldValidator = new FormFieldValidator();
    ...
    public void initExpressionManager() {
        if (expressionManager == null) {
            ...
            if (expressionManagerConfigurers != null) {
                expressionManagerConfigurers.forEach(configurer -> configurer.accept(formExpressionManager));
            }
    ...
    protected SchemaManager createEngineSchemaManager() {
        return new FormDbSchemaManager();
    }
    ...
    public FormEngineConfiguration setFormFieldValidator(FormFieldValidator formFieldValidator) {
