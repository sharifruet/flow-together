...
import org.flowable.form.engine.impl.cmd.DeleteFormInstancesByProcessInstanceCmd;
import org.flowable.form.engine.impl.cmd.DeleteFormInstancesByScopeDefinitionCmd;
import org.flowable.form.engine.impl.cmd.DeleteFormInstancesByScopeIdCmd;
...
public class FormServiceImpl extends CommonEngineServiceImpl<FormEngineConfiguration> implements FormService {
    ...
    public void validateFormFields(String elementId, String elementType, String scopeId, String scopeDefinitionId,
        ...
        commandExecutor.execute(new ValidateFormFieldsCmd(elementId, elementType, scopeId, scopeDefinitionId, scopeType, formInfo, values));
    }

    @Override
    public void validateFormFields(String elementId, String elementType, String scopeId, String scopeDefinitionId,
            String scopeType, FormInfo formInfo, Map<String, Object> values, String outcome) {
        commandExecutor.execute(new ValidateFormFieldsCmd(elementId, elementType, scopeId, scopeDefinitionId, scopeType, formInfo, values, outcome));
    }
    ...
    @Override
    public FormInstanceInfo getFormInstanceModelByKeyAndParentDeploymentIdAndScopeId(String formDefinitionKey, String parentDeploymentId, String taskId,
        String scopeId, String scopeType, Map<String, Object> variables, String tenantId, boolean fallbackToDefaultTenant) {

        return commandExecutor.execute(new GetFormInstanceByScopeModelCmd(formDefinitionKey, parentDeploymentId, taskId,
                        scopeId, scopeType, tenantId, variables, fallbackToDefaultTenant));
    }
    ...
    @Override
    public void deleteFormInstancesByProcessInstance(String processInstanceId) {
        commandExecutor.execute(new DeleteFormInstancesByProcessInstanceCmd(processInstanceId));
    }

    @Override
    public void deleteFormInstancesByScopeId(String scopeId, String scopeType) {
        commandExecutor.execute(new DeleteFormInstancesByScopeIdCmd(scopeId, scopeType));
    }
