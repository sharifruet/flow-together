...
public class DeleteFormInstancesByProcessInstanceCmd implements Command<Void>, Serializable {

    private static final long serialVersionUID = 1L;
    protected String processInstanceId;

    public DeleteFormInstancesByProcessInstanceCmd(String processInstanceId) {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        formInstanceEntityManager.deleteFormInstancesByProcessInstanceId(processInstanceId);
