...
public class DeleteFormInstancesByScopeIdCmd implements Command<Void>, Serializable {

    private static final long serialVersionUID = 1L;
    protected String scopeId;
    protected String scopeType;

    public DeleteFormInstancesByScopeIdCmd(String scopeId, String scopeType) {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        formInstanceEntityManager.deleteFormInstancesByScopeIdAndScopeType(scopeId, scopeType);
