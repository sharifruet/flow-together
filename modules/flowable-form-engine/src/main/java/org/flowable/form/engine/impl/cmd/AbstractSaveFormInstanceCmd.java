        ...
        for (String fieldId : fieldMap.keySet()) {
            ...
            if (variables != null && variables.containsKey(fieldId)) {
                ...
                if (variableValue == null) {
                    ...
                    valuesNode.put(fieldId, (BigDecimal) variableValue);

                } else if (variableValue instanceof Boolean) {
                    valuesNode.put(fieldId, (Boolean) variables.get(fieldId));

                } else if (FormFieldTypes.DATE.equals(formField.getType()) || variableValue instanceof java.time.temporal.Temporal
                        || variableValue instanceof java.util.Date) {
                    valuesNode.put(fieldId, String.valueOf(FormValueUtil.toDateFieldValue(variableValue)));
