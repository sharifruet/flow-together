...
public class GetFormInstanceByScopeModelCmd extends AbstractGetFormInstanceModelCmd {
    ...
    public GetFormInstanceByScopeModelCmd(String formDefinitionKey, String parentDeploymentId, String taskId, String scopeId, String scopeType,
                    String tenantId, Map<String, Object> variables, boolean fallbackToDefaultTenant) {

        initializeValuesForScope(formDefinitionKey, parentDeploymentId, null, tenantId, taskId,
                        scopeId, scopeType, variables, fallbackToDefaultTenant);
    }
}
